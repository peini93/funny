...
var gfyObject = function (gfyElem, classname) {
    ...
    function initOptions() {
      opt = {
        ...
        controls: true, // Option: display title on hover over
        ...
        responsive: true, // Option: element takes 100% width of a container
    ...
    * @returns {Promise}
    */
    customObj.init = function (newData) {
    ...
    */
    ...
    function onPlay() {
      setCtrlsPlaying();
      $(customObj).trigger('onPlay');
      //var evt = new Event('onPlay');
      //customObj.dispatchEvent();
    }
    function onEnd(){

      $(customObj).trigger('onEnd');
    ...
    customObj.refresh = function() {
        vid.load();
        //play();
        //$(customObj).trigger("end");
    }

    customObj.getRootElement = function() {
      return gfyRootElem;
    }
